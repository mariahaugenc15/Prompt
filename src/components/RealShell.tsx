...
// send) — these aren't gated by the mock app's loggedIn flag, so they don't
// use the mock Shell/BottomNav either. Same header for cohesive branding,
// no bottom tabs since those are mock-app-specific.
